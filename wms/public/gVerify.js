...
!(function(window, document) {
    ...
    GVerify.prototype = {
      ...
      refresh: function() {
        ...
        for (var i = 1; i <= 4; i++) {
          ...
          ctx.font = randomNum(this.options.height / 1.1, this.options.height) + "px SimHei"; //随机生成字体大小
    ...
    function getAllLetter() {
      var letterStr = "a,b,c,d,e,f,g,h,k,m,n,p,q,r,s,t,w,x,y,A,B,C,D,E,F,G,H,J,K,L,M,N,P,Q,R,S,T,U,V,W,X,Y,Z"
